...
def process_triangulated_poly(triangulated_vertices):
    """
    Processes a polygon that has already been triangulated.

    Args:
        triangulated_vertices: A list of triangles, where each triangle is a tuple of three vertices,
                               and each vertex is a sequence of coordinate components.
                               Example: [((x1, y1), (x2, y2), (x3, y3)), ...]

    Returns:
        A generator or list of triangles, each in the same format as the input.
    """
    for triangle in triangulated_vertices:
        yield triangle
...
for triangle in process_triangulated_poly(triangulated_vertices):
    print(triangle)
